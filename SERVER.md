...
Também ajuste os caminhos `/home/matheustorresdev/theblog/public/` e
`/home/matheustorresdev/theblog/public/uploads/`
...
server {
  ...
  location /public/ {
    alias /home/matheustorresdev/theblog/public/;
  }

  # Servir arquivos estáticos do /public
  location /uploads/ {
    alias /home/matheustorresdev/theblog/public/uploads/;
  }
...
sudo chmod o+x /home/matheustorresdev
sudo chmod o+x /home/matheustorresdev/theblog
sudo chmod o+x /home/matheustorresdev/theblog/public
# só aqui fiz recursão para evitar mudar todos os arquivos do projeto
sudo chmod -R o+rx /home/matheustorresdev/theblog/public/uploads
```
...
server {
  ...
  root /home/matheustorresdev/theblog;
...
echo "cd /home/matheustorresdev/theblog"
cd /home/matheustorresdev/theblog
echo
...
```sh
ssh matheustorresdev@theblog.otaviomiranda.com.br './refresh-theblog.sh'
```
